package fuzs.enderzoology.common.client.model.geom;
...
public class ModModelLayers {
    ...
    public static final ArmorModelSet<ModelLayerLocation> FALLEN_KNIGHT_ARMOR = MODEL_LAYERS.registerArmorSet(
            "fallen_knight");
    public static final ModelLayerLocation INFESTED_ZOMBIE = MODEL_LAYERS.registerModelLayer("infested_zombie");
    public static final ArmorModelSet<ModelLayerLocation> INFESTED_ZOMBIE_ARMOR = MODEL_LAYERS.registerArmorSet(
            "infested_zombie");
    public static final ModelLayerLocation INFESTED_ZOMBIE_BABY = MODEL_LAYERS.registerModelLayer("infested_zombie_baby");
    public static final ArmorModelSet<ModelLayerLocation> INFESTED_ZOMBIE_BABY_ARMOR = MODEL_LAYERS.registerArmorSet(
            "infested_zombie_baby");
